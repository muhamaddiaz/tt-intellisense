...
Either way you get `tt-intellisense-1.0.1.vsix` in the project root.
...
```powershell
# Windows
cursor --install-extension .\tt-intellisense-1.0.1.vsix
```

```bash
# macOS and Linux
cursor --install-extension ./tt-intellisense-1.0.1.vsix
```
